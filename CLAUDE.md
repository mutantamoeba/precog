...
- `docs/foundation/ARCHITECTURE_DECISIONS_V2.39.md` - 116+ ADRs including ADR-118 + ADR-119 (Canonical Layer Foundation — Epic #972; ADR-118 Cohort 1 amendment per #996 encoded in V2.38, Cohort 2 amendment per session 73 encoded in V2.39) (count may drift from document head — the V2.x version bumps track document revisions, not ADR count)
- `docs/foundation/DEVELOPMENT_PHASES_ERA2_V1.2.md` - Phase roadmap (Era 2: current)

**Implementation:**
- `docs/guides/DEVELOPMENT_PATTERNS_V1.36.md` - 82 development patterns with examples (V1.36 adds Pattern 81 Open Canonical Enum → Lookup Table + Pattern 82 CONSTRAINT TRIGGER for Polymorphic Typed Back-Ref, operationalizing ADR-118 v2.38 Cohort 1 amendment)
