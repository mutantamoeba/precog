...
class TestDbHelp:
    ...
    def test_db_help_shows_commands(self, runner):
...
class TestDbInit:
    ...
    @patch("precog.database.connection.test_connection")
    def test_init_connection_failure(self, mock_test_conn, runner):
    ...
    @patch("precog.database.connection.test_connection")
    def test_init_dry_run(self, mock_test_conn, runner):
...
class TestDbStatus:
    ...
    def test_status_connected(self, mock_get_conn, runner):
    ...
    @patch("precog.database.connection.get_connection")
    def test_status_disconnected(self, mock_get_conn, runner):
    ...
    @patch("precog.database.connection.get_connection")
    def test_status_verbose(self, mock_get_conn, runner):
...
class TestDbMigrate:
    ...
    @patch("precog.database.connection.get_connection")
    @patch("precog.database.initialization.apply_migrations")
    def test_migrate_success(self, mock_apply, mock_get_conn, runner):
    ...
    @patch("precog.database.connection.get_connection")
    @patch("precog.database.initialization.apply_migrations")
    def test_migrate_no_pending(self, mock_apply, mock_get_conn, runner):
...
class TestDbTables:
    ...
    @patch("precog.database.connection.get_connection")
    def test_tables_lists_tables(self, mock_get_conn, runner):
    ...
    @patch("precog.database.connection.get_connection")
    def test_tables_empty_database(self, mock_get_conn, runner):
...
class TestDbEdgeCases:
    ...
    @patch("precog.database.connection.get_connection")
    def test_connection_timeout(self, mock_get_conn, runner):
