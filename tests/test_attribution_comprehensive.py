...
def test_property_attribution_immutability(
    ...
    def check_immutability(calc_prob, mkt_price):
        ...
        assert pos_1 is not None, "Position should exist"
        assert pos_2 is not None, "Position should exist"
...
def test_stress_bulk_trade_creation(
    ...
    assert sample_trade is not None, "Trade should exist"
...
def test_chaos_trade_with_probability_boundary_values(
    ...
    assert trade_obj_1 is not None, "Trade should exist"
    ...
    assert trade_obj_2 is not None, "Trade should exist"
    ...
    assert trade_obj_3 is not None, "Trade should exist"
