...
def test_strategy_config_nested_versioning(db_pool, clean_test_data, sample_strategy_config_nested):
    ...
    assert strategy_id is not None, "Strategy should be created"
...
def test_strategy_config_independent_versioning(db_pool, clean_test_data):
    ...
    assert strategy_id_v1 is not None, "Strategy v1 should be created"
    assert strategy_id_v2 is not None, "Strategy v2 should be created"
...
def test_analytics_query_roi_by_model(
    ...
    assert trade_1 is not None, "Trade 1 should exist"
    assert trade_2 is not None, "Trade 2 should exist"
...
def test_analytics_query_edge_vs_outcome(db_pool, clean_test_data, sample_market, sample_strategy):
    ...
    assert trade_high is not None, "High edge trade should exist"
    assert trade_low is not None, "Low edge trade should exist"
