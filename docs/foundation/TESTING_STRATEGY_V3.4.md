...
- **Requirements:** `docs/foundation/MASTER_REQUIREMENTS_V2.21.md` - REQ-TEST-012 through REQ-TEST-019
- **ADRs:** `docs/foundation/ARCHITECTURE_DECISIONS_V2.27.md` - ADR-074, ADR-076 (Test Type Categories)
