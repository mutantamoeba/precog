...
- **Foundation Documents** (in `docs/foundation/`):
  ...
  3. `MASTER_INDEX_V2.25.md` - Complete document inventory
  4. `ARCHITECTURE_DECISIONS_V2.18.md` - All 87 ADRs with design rationale (Phase 0-4.5)
  5. `REQUIREMENT_INDEX.md` - Systematic requirement catalog
  6. `ADR_INDEX_V1.13.md` - Architecture decision index
