...
| **ARCHITECTURE_DECISIONS_V2.35.md** | ✅ | v2.33 | `/docs/foundation/` | 0 | Phases 1-10 | 🟡 High | Design rationale with ADR numbers (112 total) - **UPDATED V2.33** (ADR-110, ADR-111, ADR-112: Neil Paine, Sport-Specific Mappings, team_season_records VIEW) |
