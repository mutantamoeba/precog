...
| **DEVELOPMENT_PATTERNS_V1.18.md** | ✅ | v1.18 | `/docs/guides/` | All | All phases | 🔴 Critical | **UPDATED V1.18** - Added Pattern 29 (Hybrid Test Isolation - transaction rollback + pre-push phases + testcontainers) and Pattern 30 (Stale Bytecode Cleanup - prevents ghost tests from moved/deleted files) - 30 total patterns; Issue #171 Layer 2 implementation; cross-references ADR-057, Pattern 28 |
