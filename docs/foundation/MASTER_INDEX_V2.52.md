...
| **DEVELOPMENT_PHASES_V1.12.md** | ✅ | v1.12 | `/docs/foundation/` | 0 | All phases | 🟡 High | Complete roadmap Phase 0-10 - **UPDATED V1.12** (Phase 2.5 cloud infra, Phase 3.5 Web Interface, ADR-108) |
...
| Document | Status | Version | Location | Phase | Phase Ties | Priority | Notes |
|----------|--------|---------|----------|-------|------------|----------|-------|
| **DEVELOPMENT_PHASES_V1.12.md** | ✅ | v1.12 | `/docs/foundation/` | 0.5 | All phases | 🟡 High | **UPDATED V1.12** - Added Phase 2.5 Task 6 (Railway cloud deployment), Phase 3.5 (Web Interface), ADR-108 |
...
| **DEVELOPMENT_PATTERNS_V1.21.md** | ✅ | v1.21 | `/docs/guides/` | All | All phases | 🔴 Critical | **UPDATED V1.21** - Added Pattern 33 (API Vocabulary Alignment - schema CHECK constraints match upstream API vocabulary); 33 total patterns; Issue #255 |
