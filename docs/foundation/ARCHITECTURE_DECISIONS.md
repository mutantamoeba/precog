...
**Status:** ✅ Current
**Supersedes:** V2.42 (deleted per supersede-and-delete convention; PR #979 / PR #1009 / PR #1018 / PR #1063 precedent)
**Session:** 86
**Changes in v2.43:**
- **ADR-118 COHORT 4 SCOPE LOCK + COHORT NUMBERING CANONICALIZATION (session 86, codifying session 85 council adjudication):** Encodes 5 user-adjudicated decisions from the session 85 Cohort 4 4-agent design council (Galadriel + Holden + Miles + Uhura paired-cluster). Amendment is narrative + scope-lock + Phase B.5 criterion edit; no new tables ship under v2.43 itself — Cohort 4 build sequence begins at slot 0078 in session 86+.
  ...
  - **Item 6 — Phase B.5 exit criterion #4 split into #4a sports / #4b weather.** v2.42 carried Phase B.5 #4 as a single sports+weather canonical-layer validation criterion (originating in v2.37 ADR-119 framing where weather Phase 1 was a Cohort 4-adjacent deliverable). v2.43 splits:
