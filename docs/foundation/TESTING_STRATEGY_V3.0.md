...
- **ADRs:** `docs/foundation/ARCHITECTURE_DECISIONS_V2.17.md` - ADR-074, ADR-076 (Test Type Categories)
- **Patterns:** `docs/guides/DEVELOPMENT_PATTERNS_V1.3.md` - Pattern 13 (Test Coverage Quality)
