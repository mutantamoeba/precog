...
### **Reference**
- **Schema**: `docs/database/DATABASE_SCHEMA_SUMMARY_V1.12.md` (lines 277-374)
...
### **Reference**
- **Schema**: `docs/database/DATABASE_SCHEMA_SUMMARY_V1.12.md` (lines 376-476)
...
### **Reference**
- **Schema**: `docs/database/DATABASE_SCHEMA_SUMMARY_V1.12.md` (lines 507-545)
...
### **Database Schema**
- **`docs/database/DATABASE_SCHEMA_SUMMARY_V1.12.md`** - Complete schema (25 tables)
