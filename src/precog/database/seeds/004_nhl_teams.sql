...
('MTL', 'Montreal Canadiens', 'Canadiens', 'nhl', 'nhl', '10', 1420, 'Eastern', 'Atlantic'),
('OTT', 'Ottawa Senators', 'Senators', 'nhl', 'nhl', '14', 1460, 'Eastern', 'Atlantic'),
('TBL', 'Tampa Bay Lightning', 'Lightning', 'nhl', 'nhl', '20', 1560, 'Eastern', 'Atlantic'),
('TOR', 'Toronto Maple Leafs', 'Maple Leafs', 'nhl', 'nhl', '21', 1580, 'Eastern', 'Atlantic'),
...
('NJD', 'New Jersey Devils', 'Devils', 'nhl', 'nhl', '11', 1540, 'Eastern', 'Metropolitan'),
('NYI', 'New York Islanders', 'Islanders', 'nhl', 'nhl', '12', 1480, 'Eastern', 'Metropolitan'),
('NYR', 'New York Rangers', 'Rangers', 'nhl', 'nhl', '13', 1600, 'Eastern', 'Metropolitan'),
('PHI', 'Philadelphia Flyers', 'Flyers', 'nhl', 'nhl', '15', 1440, 'Eastern', 'Metropolitan'),
('PIT', 'Pittsburgh Penguins', 'Penguins', 'nhl', 'nhl', '16', 1500, 'Eastern', 'Metropolitan'),
('WSH', 'Washington Capitals', 'Capitals', 'nhl', 'nhl', '23', 1540, 'Eastern', 'Metropolitan'),
...
('CHI', 'Chicago Blackhawks', 'Blackhawks', 'nhl', 'nhl', '4', 1360, 'Western', 'Central'),
('COL', 'Colorado Avalanche', 'Avalanche', 'nhl', 'nhl', '17', 1580, 'Western', 'Central'),
('DAL', 'Dallas Stars', 'Stars', 'nhl', 'nhl', '9', 1600, 'Western', 'Central'),
('MIN', 'Minnesota Wild', 'Wild', 'nhl', 'nhl', '30', 1540, 'Western', 'Central'),
('NSH', 'Nashville Predators', 'Predators', 'nhl', 'nhl', '27', 1480, 'Western', 'Central'),
('STL', 'St. Louis Blues', 'Blues', 'nhl', 'nhl', '19', 1480, 'Western', 'Central'),
('WPG', 'Winnipeg Jets', 'Jets', 'nhl', 'nhl', '28', 1620, 'Western', 'Central'),

-- WESTERN CONFERENCE - Pacific Division
('ANA', 'Anaheim Ducks', 'Ducks', 'nhl', 'nhl', '25', 1380, 'Western', 'Pacific'),
('CGY', 'Calgary Flames', 'Flames', 'nhl', 'nhl', '3', 1460, 'Western', 'Pacific'),
('EDM', 'Edmonton Oilers', 'Oilers', 'nhl', 'nhl', '6', 1620, 'Western', 'Pacific'),
('LAK', 'Los Angeles Kings', 'Kings', 'nhl', 'nhl', '8', 1540, 'Western', 'Pacific'),
('SJS', 'San Jose Sharks', 'Sharks', 'nhl', 'nhl', '18', 1340, 'Western', 'Pacific'),
('SEA', 'Seattle Kraken', 'Kraken', 'nhl', 'nhl', '124292', 1460, 'Western', 'Pacific'),
('VAN', 'Vancouver Canucks', 'Canucks', 'nhl', 'nhl', '22', 1560, 'Western', 'Pacific'),
('VGK', 'Vegas Golden Knights', 'Golden Knights', 'nhl', 'nhl', '37', 1600, 'Western', 'Pacific');
