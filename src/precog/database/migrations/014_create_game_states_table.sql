...
-- ============================================================================
-- This SQL migration is COMMENTED OUT because migration_029_create_game_states_table.py
...
-- - The Python version implements the correct dual-key SCD Type 2 pattern
--
-- CI EXECUTION ORDER:
-- - CI runs SQL migrations FIRST (000-016), then Python migrations
-- - Python migrations use CREATE TABLE IF NOT EXISTS which becomes a no-op
-- - If SQL 014 runs first, it creates the WRONG schema that Python 029 expects
--
-- SOLUTION:
-- - Comment out all game_states DDL in this file
-- - Let Python migration 029 be the sole source of truth
-- - Keep this file for documentation/history purposes
--
-- See also: docs/utility/SCHEMA_MIGRATION_WORKFLOW_V1.0.md
-- ============================================================================
...
-- COMMENTED OUT: Superseded by migration 029 (Python)
-- The Python migration uses the correct dual-key pattern:
--   id SERIAL PRIMARY KEY (surrogate)
--   game_state_id VARCHAR(50) (business key, format: GS-{id})
--
...
-- COMMENTED OUT: Superseded by migration 029 (Python)
-- Verification is no longer needed since game_states table is created by migration 029
--
-- DO $$
-- DECLARE
...
-- Note: This migration file is preserved for documentation/history.
-- The actual game_states table is created by migration_029_create_game_states_table.py
